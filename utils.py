...
def get_prompt(query: str, context: str):
	prompt = f"""
		...
		Answer the following question as truthfully as possible using the provided text, and if the answer is not contained within the text below, say "I don't know": 
		{query}
		"""
	return prompt
